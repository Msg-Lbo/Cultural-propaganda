        ...
        <n-table :bordered="true" :single-line="true" size="small" striped>
            <thead>
                <tr>
                    ...
                    <th style="width: 100px; text-align: center;">评论</th>
                    <th style="width: 200px; text-align: center;">创建时间</th>
                    <th style="width: 200px; text-align: center;">修改时间</th>
            ...
            <tbody>
                <tr v-for="item in articleList" :key="item.id">
                    ...
                    <td style="width: 100px; text-align: center;">{{ item.category_name }}</td>
                    <td style="width: 100px; text-align: center;">{{ item.comment_count }}</td>
                    <td style="width: 200px; text-align: center;">{{ item.create_time }}</td>
                    <td style="width: 200px; text-align: center;">{{ item.update_time }}</td>
