...
CREATE TABLE `images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 482 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `user_campaigns` VALUES (35, 'msglbo', 23, 0);
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (2, 'msglbo', '$2a$10$1BHwPwttuG3I4ksn87uKtexAEXHTz1ZXIpGNdwtu1EYTL7JSTw7xm', '管理员', '多多吃饱了', '女', '3099558241@qq.com', 'http://127.0.0.1:9090/uploads/avatars/1700572083637.jpg', '2023-09-11 16:11:03.974', '2023-11-21 21:08:06.280', 0, '[\"22\"]');
